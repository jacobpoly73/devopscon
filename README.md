...
## This repository contains a basic Maven project with a Hello-World Java WAR for a CI/CD workshop
In order to make it work, please follow the instructions below: 

> [!IMPORTANT] 
> Make sure you have Java 21 (<b>JDK</b> and not <b>JRE standalone</b>) running on your powerful laptop.
...
<ul>
  ...
  <li>Configure the code below under <TOMCAT DIR>/conf/tomcat-users.xml</li>
  <li>[LINUX / MAC] Please make sure you have execute permissions on the /bin/ directory and run chmod +x *.sh</li>
